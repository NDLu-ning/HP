...
public class ConstitutionItemMultiProvider extends ItemViewBinder<InvitationVO, ConstitutionItemMultiProvider.ViewHolder> {
    private final OnItemClickListener mListener;

    public ConstitutionItemMultiProvider(OnItemClickListener listener) {
