package com.graduation.hp.ui.navigation.article.detail;
...
public class ArticleDetailFragment extends RootFragment<ArticleDetailPresenter>
        implements ArticleDetailContact.View {

    public static final String EMPTY_HTML = "file:///android_asset/empty.html";

    public static ArticleDetailFragment newInstance(long newsId) {
