package com.graduation.hp.ui.navigation.article;
...
public class ArticleTabFragment extends BaseFragment
    ...
    public static ArticleTabFragment newInstance() {
        ArticleTabFragment fragment = new ArticleTabFragment();
        return fragment;
    }
    ...
    public static class NewsTabAdapter extends FragmentPagerAdapter {
        ...
        private ArticleListFragment[] mFragments;
        private int curPosition;

        public NewsTabAdapter(FragmentManager fm, ChannelVO[] channelVos) {
            super(fm);
            this.channelVos = channelVos;
            this.mFragments = new ArticleListFragment[channelVos.length];
        }
        ...
        public Fragment getItem(int position) {
            if (mFragments[position] == null) {
                mFragments[position] = ArticleListFragment.newInstance(position, channelVos[position]);
            }
        ...
        public ArticleListFragment getCurrentItem() {
